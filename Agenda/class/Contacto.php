<?php
    ...
    class Contacto {
        ...
        function __construct($user_id_fk = null, $nombre = null, $apellidos = null, $telefono1 = null, $telefono2 = null, $direccion = null, $id = null) {
        ...
        public static function removeById($user) {
            $conexion = BD::getConexion();
        ...
        public function persist() {
            ...
            $result = $conexion->prepare($query);
            $result->execute(array(":nombre" => $this->getNombre(),
